...
int main()
{
	...
	int n1,n5,n10,n20,n50,n100,n200,n500,n1000,n1k,n500k,amount1,amount2,amount3,n200k,amount4,n100k,n50k,amount5,n20k,amount6,n10k,amount7,amount8,n5k;
	...
	if (n100k >= 1) {
		amount4 = (amount3 - (n100*100)); //amount4 is the new value of amount if its divisbile by 100
		cout<<("\n");
	}
	
	else
	amount4 = amount; //if the amount is not divisble by 100 it'll retain its value and be assigned a new one
	...
	if (n20k >= 1) {
		amount6 = (amount5 - (n20*20)); //amount6 is the new value of amount if its divisbile by 100
		cout<<("\t20: ");
	...
	if (n10k >= 1) {
		amount7 = (amount6 - (n10*10)); //amount7 is the new value of amount if its divisbile by 10
		cout<<("\t10: ");
	...
	if (n5 >= 2) {
		cout<<("\t5: 0");
		goto peso; //go to statement to circumvent a bug
	}
		
	if (n5k == 1) {
		amount8 = (amount7 - (n5*5)); //amount8 is the new value of amount if its divisbile by 5
		cout<<("\t5: ");
